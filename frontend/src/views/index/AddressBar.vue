...
const { locale, t } = useI18n({
    messages: {
        ...
        id: {
            ok: 'OK',
            fetchAddressError: 'Kredensial email tidak valid atau alamat tidak ditemukan, kemungkinan koneksi bermasalah. Coba lagi nanti.',
            addressCredential: 'Kredensial Alamat Email',
            linkWithAddressCredential: 'Buka untuk auto login email',
            addressCredentialTip: 'Silakan salin kredensial alamat email untuk login ke akun email Anda.',
            addressPassword: 'Kata Sandi Alamat',
            userLogin: 'Login Pengguna',
            addressManage: 'Kelola',
            publicAccess: 'Akses publik aktif',
            publicAccessDisabled: 'Akses publik tidak aktif untuk alamat ini.',
            privateAccess: 'Private (JWT)',
            publicAccessLabel: 'Publik (Alamat)',
            manageUserAddresses: 'Alamat Pengguna',
            manageLocalAddresses: 'Alamat Lokal',
            publicAccessPrivate: 'Alamat ini bersifat privat. Gunakan link akses JWT.',
            publicAccessPrivateLoggedIn: 'Alamat ini privat. Anda sudah login dengan alamat lain.',
            publicAccessNotFound: 'Alamat tidak ditemukan.',
            publicAccessFailed: 'Gagal mengakses alamat publik.',
        }
    }
});
